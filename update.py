...
ref = "master"
mob_name = "mese_monster"
mob_title = "Mese Monster"
...
def updateTextures():
	...
	if not os.path.exists("textures"):
		os.mkdir("textures")
	for c in ("blue", "green", "purple", "red"):
		file_path = "textures/{}_{}.png".format(file_basename, c)
		if download(getRefUrl(file_path), file_path, False) != 0:
			print("WARNING: resource not found on remote (skipped): {}".format(file_path))
	# arrow
	download(getRefUrl("textures/mobs_mese_arrow.png"), "textures/mobs_mese_arrow.png")
